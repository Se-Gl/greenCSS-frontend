...
export default function FiveOhOh() {
  ...
  return (
    <SEO
      title='greenCSS 500 - Something has gone terribly wrong'
      ...
      <Layout className='min-h-100vh relative z-2 bg-blue-7'>
        <div id='404'>
          <ModernGrid
            header='It seems that a computer needs a break. Please come back later! - Please forgive me!'
            imageBg='blue'
            imageUrl='/images/404/404-greencss.webp'
            imageAlt='greencss 500 not found'>
            <div className='text-gray text-15px'>
              <span>
                Failure is not only human. Computers can also quit. Just wait a few minutes. On the other hand, you
                could also try our search function.{' '}
              </span>
