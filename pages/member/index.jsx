  ...
  return (
    <SEO
      ...
      <Layout className='sm:px-10px md:px-25px lg:px-50px min-h-100vh bg-blue-7'>
        <div id='member-plans'>
          <div className='mt-50px max-w-50per sm:max-w-100per md:max-w-100per lg:max-w-100per text-center mx-auto mb-100px sm:mb-50px md:mb-50px'>
            <h1>Support your world</h1>
            <p className='text-15px'>
              You decide where you donate. Compare plans, then choose the one just right for you. With a monthly
          ...
          <div className='relative min-h-100vh'>
            ...
            <div className='absolute md:relative md:my-50px sm:relative sm:my-50px bg-blue rounded-20px flex h-75vh top-20per left-0per right-0per bottom-0per z-neg-1 shadow-small-gray'>
              <ul className='m-auto text-white pt-100px md:pt-0px sm:pt-0px'>
                {tierDescription.map((tier, i) => (
                  <li key={i} className='my-15px flex'>
                    {tier.name}
                    <span className='ml-auto pl-50px'>
                      <Checkmark fillColor='fill-white' />
                    </span>
                  </li>
                ))}
              </ul>
