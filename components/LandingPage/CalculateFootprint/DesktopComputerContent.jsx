...
export default function DesktopComputerContent() {
  ...
  return (
    <div id='calculate-footprint'>
      <div className='absolute top-25per left-12per w-40rem'>
        <h2>Calculate your green footprint</h2>
        <p className='text-black-10 text-15px'>
          You - as a developer - are usually not even aware of how much CO&#x2082; you produce in a single business
          week. Calculate your digital footprint quickly and efficiently. It won&apos;t take you a minute.
        </p>
      </div>
      <>
        ...
        <div className='absolute left-42per select-none' style={{ top: '205%' }}>
          <div className='border-1px border-solid border-greencss w-15rem h-50px rounded-5px flex text-greencss px-10px'>
            <span className='my-auto'>
              weekly emission <br />
              <span className='text-20px font-600'>{(calculate / 52).toFixed(2)}</span>kg CO&#x2082;
            </span>
          </div>
        </div>
        ...
        <div className='absolute left-61per select-none' style={{ top: '205%' }}>
          <div className='border-1px border-solid border-greencss w-15rem h-50px rounded-5px flex text-greencss px-10px'>
            <span className='my-auto'>
              monthly emission <br />
              <span className='text-20px font-600'>{(calculate / 13).toFixed(2)}</span>kg CO&#x2082;
            </span>
          </div>
        </div>
        ...
        <div className='absolute left-20per w-35rem' style={{ top: '280%' }}>
          ...
          <p className='mb-0px mt-25px text-15px text-black-10'>
            ...
            that the worlds average CO&#x2082; footprint per person per year is{' '}
