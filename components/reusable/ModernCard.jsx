...
export function ModernCard({ id, header, subheader, imageBg, imageUrl, imageAlt, children }) {
  return (
...
export function ModernRevertCard({ id, header, subheader, imageBg, imageUrl, imageAlt, children }) {
  return (
    <div className='my-50px grid grid-col-12 sm:grid-col-1 md:grid-col-1 sm:mx-0px md:mx-15px' id={id}>
      <div
