    ...
    <div className='mb-100px' id='privacy-policy'>
      ...
      <div className='bg-white px-25px py-50px rounded-50px shadow-small-gray'>
        ...
        <p>
          ...
          regards to the information that they shared and/or collect in greenCSS. This policy is not applicable to any
        ...
        <h2>Log Files</h2>
        <p>
          greenCSS follows a standard procedure of using log files. These files log visitors when they visit websites.
          All hosting companies do this and a part of hosting service&apos;s analytics. The information collected by log
        ...
        <p>
          greenCSS uses &apos;cookies&apos; in order to provide the best user experiance. These cookies are used to
          store information including visitor&apos;s preferences, and the pages on the website that the visitor accessed
          or visited. The information is used to optimize the user&apos;s experience by customizing our web page content
        ...
        <p>
          Note that greenCSS has no access to or control over these cookies that are used by third-party advertisers.
        </p>
        ...
        <p>
          greenCSS does not knowingly collect any Personal Identifiable Information from children under the age of 13.
