...
export default function Terms() {
  return (
    <>
      ...
      />
      <div className='bg-white p-50px sm:p-25px rounded-50px shadow-small-gray'>
        <p className='text-15px mb-10px'>Last Revised: 2022-06-17 11:28:56</p>
        <div>
          <h3>1. OVERVIEW</h3>
          <p>
          ...
          <p>
            IF YOU DO NOT AGREE TO BE BOUND BY THIS AGREEMENT AS LAST REVISED, DO NOT USE (OR CONTINUE TO USE) THIS SITE
            OR THE SERVICES.
          </p>
        </div>
        <div>
          ...
          <p>
            ...
            eighteen (18) years of age, (ii) otherwise recognized as being able to form legally binding contracts under
            applicable law, and (iii) are not a person barred from purchasing or receiving the Services found under the
            laws of the Switzerland or other applicable jurisdiction.
          </p>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            third-party websites. In addition, Company does not censor or edit the content of any third-party websites.
            By using this Site you expressly release Company from any and all liability arising from your use of any
            third-party website. Accordingly, Company encourages you to be aware when you leave this Site and to review
        ...
        <div>
          ...
          <p>
            IN ADDITION, YOU SPECIFICALLY ACKNOWLEDGE AND AGREE THAT NO ORAL OR WRITTEN INFORMATION OR ADVICE PROVIDED
            BY COMPANY, ITS OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS, AND THIRD-PARTY SERVICE PROVIDERS WILL (I)
            CONSTITUTE LEGAL OR FINANCIAL ADVICE OR (II) CREATE A WARRANTY OF ANY KIND WITH RESPECT TO THIS SITE OR THE
            SERVICES FOUND AT THIS SITE, AND USERS SHOULD NOT RELY ON ANY SUCH INFORMATION OR ADVICE.
          </p>
          <p>
            THE FOREGOING DISCLAIMER OF REPRESENTATIONS AND WARRANTIES SHALL APPLY TO THE FULLEST EXTENT PERMITTED BY
        ...
        <div>
          ...
          <p>
            ...
            PUNITIVE, OR CONSEQUENTIAL DAMAGES WHATSOEVER, INCLUDING ANY DAMAGES THAT MAY RESULT FROM (I) THE ACCURACY,
            COMPLETENESS, OR CONTENT OF THIS SITE, (II) THE ACCURACY, COMPLETENESS, OR CONTENT OF ANY SITES LINKED
            (THROUGH HYPERLINKS, BANNER ADVERTISING OR OTHERWISE) TO THIS SITE, (III) THE SERVICES FOUND AT THIS SITE OR
            ANY SITES LINKED (THROUGH HYPERLINKS, BANNER ADVERTISING OR OTHERWISE) TO THIS SITE, (IV) PERSONAL INJURY OR
          ...
          <p>
            IN ADDITION, You SPECIFICALLY ACKNOWLEDGE AND agree that any cause of action arising out of or related to
          ...
          <p>
            THE FOREGOING LIMITATION OF LIABILITY SHALL APPLY TO THE FULLEST EXTENT PERMITTED BY LAW, AND shall survive
        ...
        <div>
          ...
          <p>
            ...
            by Company directly or indirectly arising from (i) your use of and access to this Site; (ii) your violation
            of any provision of this Agreement or the policies or agreements which are incorporated herein; and/or (iii)
        ...
        <div>
          <h3>10. AVAILABILITY OF WEBSITE</h3>
          <p>
        ...
        <div>
          <h3>11. DISCONTINUED SERVICES</h3>
          <p>
            ...
            service will no longer be supported by Company. In such case, Company will either offer a comparable Service
            for you to migrate to or a refund. Company will not be liable to you or any third party for any
        ...
        <div>
          ...
          <p>You acknowledge and agree that your payment will be charged and processed by greenCSS.</p>
          <p>
            You agree to pay any and all prices and fees due for Services purchased or obtained at this Site at the time
          ...
          <p>
            ...
            or modifications shall be posted online at this Site and effective immediately without need for further
            notice to you.
          </p>
          <p>
            Except as expressly provided in these Terms, all charges and payments are non-refundable, non-cancellable,
            and non-creditable, even if your Services are suspended, terminated, or transferred prior to the end of the
            Services term.
          </p>
        </div>
        <div>
        ...
        <div>
          <h3>14. COMPLIANCE WITH LOCAL LAWS</h3>
          <p>
            Company makes no representation or warranty that the content available on this Site are appropriate in every
            country or jurisdiction, and access to this Site from countries or jurisdictions where its content is
            illegal is prohibited. Users who choose to access this Site are responsible for compliance with all local
        ...
        <div>
          ...
          <p>
            ...
            formation shall be governed by and construed in accordance with the laws of Switzerland, Zurich, to the
        ...
        <div>
          ...
          <p>
            ...
            conducted in Switzerland, Zurich, and judgment on the arbitration award may be entered into any court having
            jurisdiction thereof.
          </p>
        </div>
        <div>
          <h3>17. TITLES AND HEADINGS</h3>
          <p>
        ...
        <div>
          ...
          <p>
            ...
            provision) of this Agreement to be illegal, invalid, or otherwise unenforceable, the remaining provisions
            (or portions of provisions) of this Agreement shall not be affected thereby and shall be found to be valid
            and enforceable to the fullest extent permitted by law.
          </p>
        </div>
        <div>
          <h3>19. Region of the donation</h3>
          <p>
            We usually try to donate in your region or country. If this is not possible, we are entitled to donate in
            the immediate vicinity of your requested region or country.
          </p>
        </div>
        <div>
          ...
          <p className='mb-0px'>greenCSS</p>
          <p className='mb-0px'>Switzerland</p>
          <p>info@greencss.dev</p>
          <div className='flex'>
            <p className='mb-0px'>or use the contact form at the</p>
            <Link href='/contact'>
              <a className='text-20px font-500 cursor-pointer my-0px no-decoration ml-5px'> contact page.</a>
            </Link>
          </div>
        </div>
      </div>
